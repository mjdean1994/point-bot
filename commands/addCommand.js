...
module.exports = function(guild, args, isAdmin, callback) {
    ...
    if(!identities || !value) {
        callback('Invalid syntax. Use the following syntax for this command: `add {value} {characters}`', null)
        return
    }
    ...
    for(var i = 0; i < identities.length; i++) {
        ...
        resp.push(`Granted **${value}** points to **${element}**. They now have **${newValue}** ${newValue === 1 ? 'point' : 'points'}`)
